...
<h2>Tensorflow-Tiled-Image-Segmentation-Augmented-BCNB (Updated: 2024/08/30)</h2>
...
2. We applied the Tiled-Image Segmentation inference method to predict the cancer regions for the mini_test images 
...
As shown below, the tiled inferred masks look slightly similar to the ground truth masks. <br>
<!--
...
<img src="./projects/TensorflowSlightlyFlexibleUNet/Tiled-BCNB/asset/train_console_output_at_epoch_49.png" width="720" height="auto"><br>
<br>
...
<img src="./projects/TensorflowSlightlyFlexibleUNet/Tiled-BCNB/asset/evaluate_console_output_at_epoch_49.png" width="720" height="auto">
<br><br>

<a href="./projects/TensorflowSlightlyFlexibleUNet/Tiled-BCNB/evaluation.csv">evaluation.csv</a><br>

In this experiment, the loss (bce_dice_loss) and dice_coef to this Tiled-BCNB/test were still poor results,
but slightly improved from the previous results as shown below.
<br>
<pre>
loss,0.3791
dice_coef,0.4708
...
but tiled inferencer can generate slightly better results than non-tiled inferencer.
